 ...
 * order.
 *
 * Intended for use with formidable in scenarios where the
 * IncomingForm is created initialized in a route after something
 * async has happened (authentication via a socket, for instance).
 */
